...
const envSchema = z.object({
    ...
    MONGODB_URI: z.string().refine((uri) => uri.startsWith('mongodb://') || uri.startsWith('mongodb+srv://'), { message: 'MONGODB_URI must be a valid mongodb:// or mongodb+srv:// connection string' }),
